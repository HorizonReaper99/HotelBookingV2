...
<html lang="en">
    <head>
        ...
        <title>Hotel Bookings Form</title>
       ...
       <select name="hotelname" required>
           <option value="Hilton Kuwait">Hilton Kuwait</option>
           <option value="Sun City">Sun City</option>
           <option value="Garden Court Nelson Mandela Boulevard">Garden Court Nelson Mandela Boulevard</option>
           <option value="The Cellars-Hohenort Hotel">The Cellars-Hohenort Hotel</option>
       </select><br>
...
switch($_SESSION['hotelname']){
 case "Hilton Kuwait":
 $value = $daysbooked * 4100;
 break;

 case "Sun City":
 $value = $daysbooked * 2429;
 break;

 case "Garden Court Nelson Mandela Boulevard":
 $value = $daysbooked * 1322;
 break;

 case "The Cellars-Hohenort Hotel":
 $value = $daysbooked * 1565;
 break;
